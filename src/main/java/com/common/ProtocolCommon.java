...
public class ProtocolCommon {
	...
	public static final String RESULT_CODE_INVALID_PASSWORD = "418";
	public static final String RESULT_CODE_INVALID_KEY = "419";
	public static final String RESULT_CODE_INVALID_SITEID = "420";
	public static final String RESULT_CODE_NO_DATA = "421";
	public static final String RESULT_CODE_MISMATCH = "423";
	...
	public static final String RESULT_CODE_NO_PCAGENT_SETUP_DATA = "433";
	...
	public static final String RESULT_MESSAGE_INVALID_PASSWORD = "invalid password";
	public static final String RESULT_MESSAGE_INVALID_KEY = "invalid key";
	...
	public static final String RESULT_MESSAGE_NO_PCAGENT_SETUP_DATA = "no pc agent setup data";
	public static final String RESULT_MESSAGE_INVALID_SITEID = "no siteid";
	public static final String RESULT_MESSAGE_MISMATCH = "mismatch";
